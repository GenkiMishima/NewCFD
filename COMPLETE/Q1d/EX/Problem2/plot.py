...
data1 = sp.genfromtxt('data/density_109.d')
x1 = data1[:,0]
y1 = data1[:,1]/data1[1,1]
plt.plot(x1,y1)
plt.savefig('data/density.png')

data3 = sp.genfromtxt('data/pressure_109.d')
x3 = data3[:,0]
y3 = data3[:,1]/data3[1,1]
plt.plot(x3,y3)
plt.savefig('data/pressure.png')

data4 = sp.genfromtxt('data/Mach_109.d')
x4 = data4[:,0]
y4 = data4[:,1]
M = data4[1,1]
plt.plot(x4,y4)
...
data2 = sp.genfromtxt('data/U_Velocity_109.d')
x2 = data2[:,0]
sonic = data2[1,1]/M
y2 = data2[:,1]/sonic
plt.plot(x2,y2)
