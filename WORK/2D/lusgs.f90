subroutine calc_next_step_inp(q,w,Flux,Source,dt,dx,Vol,sonic,A)
   ...
   implicit none
   integer i,j
   double precision,dimension(3,0:ni) :: q,w,Flux,Source,rhs,dq
   double precision,dimension(  0:ni) :: Vol,sonic,A
   double precision,dimension(  0:ni) :: NUMax,abar,factor
   ...
   double precision,dimension(3,3,0:ni) :: dfdq
