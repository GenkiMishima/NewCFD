module variable
   use prmtr
   integer time
   double precision, dimension(3,-1:ni  ,-1:nj  ) :: w, w_left, w_right, w_down, w_up
   double precision, dimension(3, 1:ni  , 1:nj  ) :: wp,q,qq
   double precision, dimension(3, 1:ni  , 1:nj  ) :: X_Flux, X_Numerical,vis_i
   double precision, dimension(3, 1:ni  , 1:nj  ) :: Y_Flux, Y_Numerical,vis_j
   double precision, dimension(3, 0:ni  , 0:nj  ) :: RHS, q_imp
   double precision, dimension(3, 1:ni  , 1:nj  ) :: X_inst
   double precision, dimension(3, 1:ni  , 1:nj  ) :: Y_inst
   ...
   double precision, dimension(3,3)               :: X_matrix, X_inverse, lambda, Y_matrix
   double precision, dimension(3,3)               :: Y_inverse, matrix, instant_matrix
   double precision, dimension(3,3)               :: inverse_matrix
   double precision, dimension(3,3)               :: Xlambda_matrix, XlambdaX_matrix
   double precision, dimension(3,3)               :: Ylambda_matrix, YlambdaY_matrix
   double precision, dimension(3)                 :: dq, convective_vector, temp
   double precision, dimension(3)                 :: temp_arrey1, temp_arrey2, flux
   double precision, dimension(3)                 :: corner_for, corner_back
   double precision, dimension(3)                 :: delta_x, delta_r
