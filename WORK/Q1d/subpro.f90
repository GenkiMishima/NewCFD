...
implicit none
integer i
double precision,dimension(1:3,0:CellNum)::w,q
double precision,dimension(    0:CellNum)::sonic,PreResi,x,Vol
double precision pL,uL,rL,TL,pR,uR,rR,tR
double precision temp(0:3)
do i=0,CellNum
   temp(0) = (rR-rL)/float(CellNum-1)
   temp(1) = (uR-uL)/float(CellNum-1)
   temp(2) = (pR-pL)/float(CellNum-1)
...
implicit none
integer i
double precision,dimension(1:3,0:CellNum)::q
double precision,dimension(    0:CellNum)::PreResi
double precision temp(0:3)
...
implicit none
integer i
double precision,dimension(1:3,0:CellNum)::q,w
double precision,dimension(    0:CellNum)::sonic
double precision temp(0:3)
double precision t
do i=1,CellNum-1
   w(1,i)=q(1,i)
