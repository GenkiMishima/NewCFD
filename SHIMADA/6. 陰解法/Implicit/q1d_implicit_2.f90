...
!
			...
			abar_p = A(i+1)
!
			alpha(1,1,i) = - ( 2.* dfdq_m_11 * abar_m + dfdq_p_11 * abar_p ) / 6.
			alpha(1,2,i) = - ( 2.* dfdq_m_12 * abar_m + dfdq_p_12 * abar_p ) / 6.
			alpha(1,3,i) = - ( 2.* dfdq_m_13 * abar_m + dfdq_p_13 * abar_p ) / 6.
			alpha(2,1,i) = - ( 2.* dfdq_m_21 * abar_m + dfdq_p_21 * abar_p ) / 6.
			alpha(2,2,i) = - ( 2.* dfdq_m_22 * abar_m + dfdq_p_22 * abar_p ) / 6.
			alpha(2,3,i) = - ( 2.* dfdq_m_23 * abar_m + dfdq_p_23 * abar_p ) / 6.
			alpha(3,1,i) = - ( 2.* dfdq_m_31 * abar_m + dfdq_p_31 * abar_p ) / 6.
			alpha(3,2,i) = - ( 2.* dfdq_m_32 * abar_m + dfdq_p_32 * abar_p ) / 6.
			alpha(3,3,i) = - ( 2.* dfdq_m_33 * abar_m + dfdq_p_33 * abar_p ) / 6.
!
			beta(1,1,i) = vol(i)/dt             +5.*(-dfdq_m_11 * abar_m + dfdq_p_11 * abar_p ) / 6.
			beta(1,2,i) = 0.					+5.*(-dfdq_m_12 * abar_m + dfdq_p_12 * abar_p ) / 6.
			beta(1,3,i) = 0.					+5.*(-dfdq_m_13 * abar_m + dfdq_p_13 * abar_p ) / 6.
			beta(2,1,i) =-vol(i)*dsdq_21		+5.*(-dfdq_m_21 * abar_m + dfdq_p_21 * abar_p ) / 6.
			beta(2,2,i) = vol(i)*(1./dt-dsdq_22)+5.*(-dfdq_m_22 * abar_m + dfdq_p_22 * abar_p ) / 6.
			beta(2,3,i) =-vol(i)*dsdq_23		+5.*(-dfdq_m_23 * abar_m + dfdq_p_23 * abar_p ) / 6.
			beta(3,1,i) = 0.					+5.*(-dfdq_m_31 * abar_m + dfdq_p_31 * abar_p ) / 6.
			beta(3,2,i) = 0.					+5.*(-dfdq_m_32 * abar_m + dfdq_p_32 * abar_p ) / 6.
			beta(3,3,i) = vol(i)/dt				+5.*(-dfdq_m_33 * abar_m + dfdq_p_33 * abar_p ) / 6.
!
			gamma(1,1,i) = ( 2.* dfdq_p_11 * abar_p + dfdq_m_11 * abar_m ) / 6.
			gamma(1,2,i) = ( 2.* dfdq_p_12 * abar_p + dfdq_m_12 * abar_m ) / 6.
			gamma(1,3,i) = ( 2.* dfdq_p_13 * abar_p + dfdq_m_13 * abar_m ) / 6.
			gamma(2,1,i) = ( 2.* dfdq_p_21 * abar_p + dfdq_m_21 * abar_m ) / 6.
			gamma(2,2,i) = ( 2.* dfdq_p_22 * abar_p + dfdq_m_22 * abar_m ) / 6.
			gamma(2,3,i) = ( 2.* dfdq_p_23 * abar_p + dfdq_m_23 * abar_m ) / 6.
			gamma(3,1,i) = ( 2.* dfdq_p_31 * abar_p + dfdq_m_31 * abar_m ) / 6.
			gamma(3,2,i) = ( 2.* dfdq_p_32 * abar_p + dfdq_m_32 * abar_m ) / 6.
			gamma(3,3,i) = ( 2.* dfdq_p_33 * abar_p + dfdq_m_33 * abar_m ) / 6.
		end do
!
! LU-decomposition
!
